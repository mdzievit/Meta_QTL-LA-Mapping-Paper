...
6. Plotted the results in "QTL\_Maps\_Code.r" using the single marker scan results and the LOD results to generate figure 2 and supplemental figure 2 from the paper
